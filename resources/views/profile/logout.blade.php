    ...
    <div class="flex flex-wrap">
        ...
        <div class="w-full md:w-1/4 mb-6 md:mb-0 md:pr-4">
            ...
            <div class="bg-white rounded-xl p-4 shadow-md space-y-2">
                ...
                <a href="#" class="flex items-center py-3 px-4 bg-blue-500 text-gray-100 rounded-xl shadow-sm">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div class="flex justify-start space-x-4">
                    <form action="{{ route('logout') }}" method="POST" class="inline">
                        @csrf
                        <button type="submit" class="bg-red-500 hover:bg-red-600 text-white py-2 px-12 rounded-full text-sm font-medium transition-all duration-200">Keluar</button>
                    </form>
                </div>
            </div>
        </section>
