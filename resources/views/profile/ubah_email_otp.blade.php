...
@section('title', 'Ubah Email OTP - PhoneKu')
        ...
        <div class="flex flex-wrap">
            ...
            <section class="w-full md:w-3/4">
                ...
                <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                    <h3 class="text-2xl font-semibold text-gray-700 mb-2">Verifikasi Email Baru</h3>
                    <p class="text-gray-500 mb-6">Masukkan kode.</p>
                    <form method="POST" action="{{ route('verifikasi_otp_ubah_email') }}">
                    @csrf
                        <div class="container">
                        <!-- OTP Email -->
                        <div class="mb-6">
                            <label for="otp" class="block text-sm font-medium text-gray-700 mb-3">Kode OTP</label>
                            <input type="text" name="otp" id="otp" required placeholder="Masukkan Kode OTP"
