        ...
        <div class="flex flex-wrap">
            ...
            <section class="w-full md:w-3/4 ">
                <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                    ...
                    <div
                        class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition duration-300">
                        <div class="flex flex-col md:flex-row md:items-center gap-8 md:gap-12">
                            ...
                            <div class="flex flex-row gap-4 w-full md:w-2/3">
                                ...
                                <div class="flex flex-col justify-between w-full text-base text-gray-700 space-y-1">
                                    <h4 class="text-lg font-semibold text-gray-800">iPhone 11</h4>
                                    <p>Warna: Merah</p>
                                    <p>SKU: 8100019113</p>
                            ...
                            <div class="flex flex-col gap-3 w-full md:w-1/3">
                                <!-- Transaksi berhasil -->
                                <span class="bg-green-100 text-green-700 text-sm px-4 py-2 rounded-full text-center w-full">
                                    Transaksi berhasil
                                </span>
                                ...
                                <div class="text-sm text-right">
                                    ...
                                    <p class="font-semibold text-gray-800">Rp5.999.999</p>
                                </div>

                                <!-- Tombol -->
                                <button
                                    class="bg-blue-500 hover:bg-blue-600 text-white text-sm px-5 py-2 rounded-full sm:w-full">
                                    Beli Lagi
                                </button>
                            </div>
                        </div>
