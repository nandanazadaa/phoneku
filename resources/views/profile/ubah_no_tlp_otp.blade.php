    ...
    <div class="container mx-auto px-4 py-8 -mt-48 relative z-10">
        ...
        <section class="w-full md:w-3/4">
            <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                <h3 class="text-2xl font-semibold text-gray-700 mb-2">Verifikasi Nomer Telepon Baru</h3>
                ...
                <form>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-gray-500 mt-2">Silakan masukkan 6 digit kode yang telah dikirim ke WhatsApp Anda.</p>
                    </div>
