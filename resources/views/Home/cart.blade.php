                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 ml-8">
                            ...
                            <div class="flex flex-col md:flex-row md:items-start justify-between gap-6 border-b pb-6">
                                ...
                                <div class="flex flex-col items-start gap-3 w-full md:w-auto">
                                    <div class="flex justify-between items-center w-full">
                                        <p class="text-xl font-semibold mr-2">Rp{{ number_format($item->product->price * $item->quantity, 0, ',', '.') }}</p>
                                    ...
                                    <form action="{{ route('cart.update', $item->id) }}" method="POST" class="flex items-center border rounded-full px-3 py-1 md:mt-12">
                                        @csrf
                    ...
                    <div class="w-full">
                        <div class="bg-white shadow rounded-xl p-6 border">
                            ...
                            <button type="submit" class="w-full bg-blue-400 text-white py-2 rounded-lg font-semibold hover:bg-blue-600 transition duration-200">
